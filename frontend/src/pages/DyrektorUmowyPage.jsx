...
export function DyrektorUmowyPage() {
  ...
  return (
    <DyrektorLayout title="Umowy zespołu">
      <section className="dash-panel" style={{ maxWidth: '100%' }}>
        <div className="dash-panel__head">
          <h2 className="dash-panel__title dash-panel__title--kody">Umowy zespołu</h2>
        ...
        <p className="dash-muted" style={{ marginBottom: '1rem', fontSize: '0.9rem', maxWidth: '52rem' }}>
          Wszystkie zgłoszenia z infolinii i kalkulatora widoczne w bazie. Podgląd umowy jest{' '}
          <strong>tylko do odczytu</strong> — edycja pozostaje u infolinii i back office.
        </p>
        {err ? (
        ...
        {!err ? (
          <div className="dash-code-toolbar" style={{ flexWrap: 'wrap', gap: '0.75rem' }}>
            <div className="dash-code-filter" style={{ minWidth: '12rem', flex: '1 1 14rem' }}>
              ...
              <label htmlFor="dyrektor-umowy-code-filter" className="visually-hidden">
                Filtruj po kodzie kalkulatora
              </label>
              <input
                id="dyrektor-umowy-code-filter"
                type="search"
            ...
            <div className="dash-code-filter" style={{ minWidth: '12rem', flex: '1 1 14rem' }}>
              ...
              <label htmlFor="dyrektor-umowy-agent-filter" className="visually-hidden">
                Filtruj po handlowcu
              </label>
              <input
                id="dyrektor-umowy-agent-filter"
                type="search"
                className="dash-code-filter__input"
